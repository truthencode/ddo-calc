...
/**
 * [[https://ddowiki.com/page/Venom_Immunity Venom Immunity]] You are immune to ability score damage
 * from natural poisons. (This has no effect on magical or supernatural poisons.)
 *
