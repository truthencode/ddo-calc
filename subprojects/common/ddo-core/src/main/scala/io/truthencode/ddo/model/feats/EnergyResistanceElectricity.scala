 ...
 */
trait EnergyResistanceElectricity extends EnergyResistance with FriendlyDisplay with GrantsToClass {
  self: DisplayName =>
   ...
   * @inheritdoc
   */
  override protected def nameSource: String = "Electricity"
}
