...
object Skill extends Enum[Skill] with SearchPrefix {
   ...
   */
  case object Balance extends Skill with PassiveActivation with DexterityLinked
   ...
   */
  case object Bluff extends Skill with AtWillEvent with CharismaLinked
   ...
   */
  case object Diplomacy extends Skill with AtWillEvent with CharismaLinked
   ...
   */
  case object Haggle extends Skill with PassiveActivation with CharismaLinked
   ...
   * Sneak.
   */
  case object Hide extends Skill with PassiveActivation with DexterityLinked
   ...
   * than the creature your are trying to intimidate, or +4 for every size category your are larger.
   * Halflings suffer a -4 penalty to Intimidate due to their small size. (15 second cooldown)
   */
  case object Intimidate extends Skill with AtWillEvent with CharismaLinked

  /**
   * Allows you to jump higher. This skill has a maximum cap of 40. 9th level and higher casters can
   * cast +30 Jump (spell)
   */
  case object Jump extends Skill with PassiveActivation with StrengthLinked
   ...
   */
  case object Listen extends Skill with PassiveActivation with WisdomLinked
   ...
   * Sonic Spell Power.
   */
  case object Perform extends Skill with PassiveActivation with CharismaLinked
   ...
   */
  case object Swim extends Skill with PassiveActivation with StrengthLinked
   ...
   * dive to the side and do back flips instead of rolling. Skill also reduces falling damage.
   */
  case object Tumble extends Skill with PassiveActivation with DexterityLinked
