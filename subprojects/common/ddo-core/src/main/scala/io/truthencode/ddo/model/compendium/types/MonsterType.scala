...
/**
 * Encompasses the main type of creature. These types are used for favored enemies, bane weapons
 * etc.
 * @note
 *   At this point, the aim is to be complete enough to support favored enemy creation and
 *   calculations. At some point in the future, a full compendium may be considered.
 */
